...
describe('Module Factory', () => {
  ...
  it('should manage name as a path', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/src/bar/foo/foo.module.ts'),
    ).not.toBeUndefined();
  ...
  it('should manage name to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/src/foo-bar/foo-bar.module.ts'),
    ).not.toBeUndefined();
  ...
  it('should manage path to dasherize', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/src/bar-baz/foo/foo.module.ts'),
    ).not.toBeUndefined();
  ...
  it('should manage javascript file', () => {
    ...
    const files: string[] = tree.files;
    expect(
      files.find(filename => filename === '/src/foo/foo.module.js'),
    ).not.toBeUndefined();
