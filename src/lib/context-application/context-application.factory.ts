...
function transform(options: ContextApplicationOptions): ContextApplicationOptions {
  const target: ContextApplicationOptions = Object.assign({}, options);
...
function generate(options: ContextApplicationOptions): Source {
