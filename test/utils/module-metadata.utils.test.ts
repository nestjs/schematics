...
describe('Module Metadata Utils', () => {
  describe('imports metadata', () => {
    it('should create the imports metadata if not exist when insert', () => {
      ...
      const output: string = ModuleMetadataUtils.insert(source, 'imports', 'FooModule');
  ...
  describe('controllers metadata', () => {
    it('should create the controllers metadata if not exist when insert', () => {
      const source =
        'import { Module } from \'@nestjs/common\';\n' +
        'import { AppController } from \'./app.controller\';\n' +
        '\n' +
        '@Module({})\n' +
        'export class ApplicationModule {}\n';
      const output: string = ModuleMetadataUtils.insert(source, 'controllers', 'FooController');
      expect(output).to.be.equal(
        'import { Module } from \'@nestjs/common\';\n' +
        'import { AppController } from \'./app.controller\';\n' +
        '\n' +
